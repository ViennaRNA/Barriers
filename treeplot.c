/* Last changed Time-stamp: <2001-03-08 16:30:19 ivo> */
/* treeplot.c */
...
static char UNUSED rcsid[]= "$Id: treeplot.c,v 1.1 2001/04/05 08:00:57 ivo Exp $";
...
PUBLIC void  PSplot_phylogeny(Union *cluster, char *filename, char *type)
{
   ...
   fprintf(fp,"475 %g div 1000 %g div scale\n", xsize, ysize); 
