...
AC_DEFUN([AC_COLOR_RESULT_PACKAGE],[
  AC_COLOR_RESULT([with_], [$1])
])

AC_DEFUN([AC_COLOR_RESULT_SIMPLE],[
  AC_COLOR_RESULT([], [$1])
])

AC_DEFUN([AC_STRING_APPEND_FORMAT_BOLD],[dnl
  AC_REQUIRE([_COLORIZE_RESULT_PREPARE])dnl
