...
static void backtrack_path_rec(int        l1,
                               int        l2,
                               const char *tag);
               ...
               int      *truemin)
{
  ...
  tag       = (char *)space(16);
  backtrack_path_rec(ll1, ll2, tag);
  path[np].hp = NULL;
